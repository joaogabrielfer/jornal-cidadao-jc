...
func (h *Handler) GetUploadChargePage(c *gin.Context) { c.HTML(http.StatusOK, "adicionar_charge.tmpl", nil) }
func (h *Handler) GetDeleteChargePage(c *gin.Context) { c.HTML(http.StatusOK, "deletar_charge.tmpl", nil) }
func (h *Handler) GetUploadArticlePage(c *gin.Context) { c.HTML(http.StatusOK, "escrever_materia.tmpl", nil) }
func (h *Handler) GetUpdateArticlePage(c *gin.Context) { c.HTML(http.StatusOK, "atualizar_materia.tmpl", nil) }
